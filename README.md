...
- 양,음 상관관계 해석을 위해 Logistic Regression 모델 학습 결과에서 추출된 가중치를 이용해 타겟(퇴사여부)에 대한 각 feature의 중요도를 수치로 확인
  ...
  ![Image](https://github.com/user-attachments/assets/170c7f4a-aa1a-4507-85a0-b74ac581a44a)<br/>
  ...
  - 급여 및 승진 체계를 조정하여 간호사들의 만족도를 높이는 것.
  - 출퇴근 부담을 줄이기 위해 기숙사, 통근버스 제공
