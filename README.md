...
간호사 이탈에 영향을 주는 주요 요인을 정량적으로 파악하고,
이를 바탕으로 효과적인 인사·복지 정책을 수립하며,
앞으로 고용 시 이탈 가능성이 낮은 특징을 가진 지원자를 선별하는 데 참고할 수 있습니다.
이로 인해 인력 채용과 교육에 드는 비용을 줄이고, 장기적으로 인사 관리 효율성을 높일 수 있습니다.
궁극적으로 조직의 인력 유지, 안정성 향상, 비용 절감 등 다양한 측면에서 데이터 기반 의사결정을 내릴 수 있습니다.
